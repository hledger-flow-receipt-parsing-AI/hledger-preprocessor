...
2. `test_transaction_hash.py`
3. `test_receipt_schema.py`
4. `test_net_amount_calculation.py`
5. `test_matching_skip_logic.py`

### Phase 2: P0 Integration Tests (use temp_finance_root)
6. Extend `test_config_loading.py` for multi-bank
7. `test_matching_auto_link.py`
8. `test_receipt_labelling.py`
...
11. `test_matching_widen_date.py`
12. `test_matching_widen_amount.py`
13. `test_matching_swap_ddmm.py`
14. `test_matching_disambiguate.py`
15. `test_matching_duplicate_blocked.py`

### Phase 5: P1 GIF Demos (real output only)
16. `real_foreign_currency_match_demo.py` + `generate.sh`
17. `real_widen_date_demo.py` + `generate.sh`
18. `real_disambiguate_demo.py` + `generate.sh`
