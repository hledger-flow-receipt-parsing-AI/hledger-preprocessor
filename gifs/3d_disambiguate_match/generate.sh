#!/usr/bin/env bash
# =============================================================================
# Disambiguate Match Demo - GIF Generator
#
# Demonstrates US-3.6: 3 similar Ekoplaza transactions require user selection.
# Jan 14 (42.17), Jan 15 (42.50), Jan 16 (42.00) — user picks the correct one.
#
...
DEMO_NAME="3d_disambiguate_match"
...
header "Disambiguate Match Demo Generator (using real CLI)"
...
asciinema rec "$CAST_FILE" \
    --command="$PYTHON -m gifs.automation.real_disambiguate_demo" \
    --title "Step 3d: Disambiguate Multiple Matches" \
    --idle-time-limit=2 \
    --rows 38 \
    --cols 100 \
    -y -q
...
echo "  with 3 similar transactions requiring user disambiguation."
echo
echo "Add to README.md:"
echo "  ![Step 3d: Disambiguate Match](gifs/3d_disambiguate_match/output/${DEMO_NAME}.gif)"
echo
