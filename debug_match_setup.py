...
def main():
    ...
    print("-" * 70)
    print()
    print("  During the matching process, you may encounter these prompts:")
    print()
    print("  1. 'ignore_keys=' - Debug prompt in has_diff_and_print()")
    print("     -> Press ENTER to continue")
    print()
    print("  2. 'EXPORTING to:' - Confirmation before saving receipt label")
    print("     -> Press ENTER to confirm save")
    print()
    ...
    print("-" * 70)
    print()
    print(f"  cat {label_path}")
    print()
    print("  Look for 'transaction_hash' field - if it's no longer null,")
    print("  the receipt was successfully linked to a CSV transaction.")
    print()
