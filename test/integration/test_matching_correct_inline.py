...
class TestCorrectInlineWidenDate:
    ...
    def test_widen_date_range_increases_days(
    ...
    def test_widen_date_range_rejects_zero(
        self, temp_finance_root
    ) -> None:
    ...
    def test_widen_date_range_rejects_negative(
        self, temp_finance_root
    ) -> None:
...
class TestCorrectInlineWidenAmount:
    ...
    def test_widen_amount_from_zero(
        self, temp_finance_root
    ) -> None:
    ...
    def test_widen_amount_from_positive(
        self, temp_finance_root
    ) -> None:
    ...
    def test_widen_amount_preserves_original(
        self, temp_finance_root
    ) -> None:
        """Original config is not mutated (deepcopy)."""
        cfg = load_config(
