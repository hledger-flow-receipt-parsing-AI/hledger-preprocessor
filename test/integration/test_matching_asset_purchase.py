...
Covers US-3.9: Physical assets (gold/silver/cash) in Currency enum.
...
class TestCurrencyTypes:
    ...
    def test_cash_in_currency(self) -> None:
        """CASH is a valid Currency enum member."""
        assert Currency.CASH.value == "CASH"
