"""E2E test for GIF 01: Setup Config demo.
...
def test_gif_01_setup_config(temp_finance_root, monkeypatch):
    """Test GIF 1: setup_config demo runs successfully and creates GIF."""
    run_gif_test(
        temp_finance_root=temp_finance_root,
        monkeypatch=monkeypatch,
        demo_name="01_setup_config",
        gif_subdir="01_setup_config",
        timeout=300,
